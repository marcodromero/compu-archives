...
import arrowRight from './assets/images/static-red-arrow-right.webp';
import arrowLeft from './assets/images/static-red-arrow-left.webp';
import Window from '../../components/Window';
import Header from '../../components/Header';
import Stores from './components/Stores';
import { useCDDetail } from './hooks/useCDDetail';
import NotFoundPage from '../404Page';

export default function CDPage() {
  const { index, cdData, handleClickNext, handleClickBack } = useCDDetail();

  if (!cdData) return <NotFoundPage />;
