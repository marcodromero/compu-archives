    ...
    <section  className=" w-full h-full p-6 flex flex-col items-center justify-between gap-15 md:gap-0">
      <div className='h-[400px]  flex flex-col justify-center items-center gap-4'>
         ...
         <nav className="w-full flex-column md:flex items-center md:gap-8 mt-2 h-[40px]">
            <NavLink to="/revistas" className="md:w-[186px] flex justify-center mb-[12px] md:mb-0" ><img src={btnRyc} className="w-2/3 h-full md:w-[186px] zoom"/></NavLink>
            <NavLink to="/acerca" className="md:w-[186px] flex justify-center mb-[12px] md:mb-0"><img src={btnLinks} className="w-2/3 h-full md:w-[186px] zoom"/></NavLink>
            <NavLink to="/comentarios" className="md:w-[186px] flex justify-center mb-[12px] md:mb-0"><img src={btnGuestbook} className="w-2/3 h-full md:w-[186px] zoom"/></NavLink>
          </nav>
      </div>
